...
import { weeklyScheduleState } from '../appStates/appSchedule';
...
const MidweekMeeting = () => {
    ...
    const classCount = appSettings.class_count;

    const weeklySchedule = useRecoilValue(weeklyScheduleState);
    ...
    useEffect(() => {
        const loadCurrentWeekData = async () => {
            ...
            let weekIndex = weeklySchedule.findIndex(weekItem => weekItem.weekOf === previousWeek);
            const hasPrevious = weekIndex === -1 ? false : true;
            setDisablePrevious(!hasPrevious);

            weekIndex = weeklySchedule.findIndex(weekItem => weekItem.weekOf === nextWeek);
            const hasNext = weekIndex === -1 ? false : true;
            ...
            weekIndex = weeklySchedule.findIndex(weekItem => weekItem.weekOf === weekValue);

            const scheduleData = weeklySchedule[weekIndex];

            if (typeof scheduleData.bibleReading_src === "undefined") {
                setBibleReadingSrc("")
            } else {
                setBibleReadingSrc(scheduleData.bibleReading_src);
            }
            setStuBReadA(scheduleData.bRead_stu_A_dispName);
            setStuBReadB(scheduleData.bRead_stu_B_dispName);
            setAss1Type(parseInt(scheduleData.ass1_type, 10));
            setAss1TypeName(scheduleData.ass1_type_name);
            setAss1Time(scheduleData.ass1_time);
            if (typeof scheduleData.ass1_src === "undefined") {
                setAss1Src("")
            } else {
                setAss1Src(scheduleData.ass1_src);
            }
            ...
            setAss2Type(parseInt(scheduleData.ass2_type, 10));
            setAss2TypeName(scheduleData.ass2_type_name);
            setAss2Time(scheduleData.ass2_time);
            if (typeof scheduleData.ass2_src === "undefined") {
                setAss2Src("")
            } else {
                setAss2Src(scheduleData.ass2_src);
            }
            ...
            setAss3Type(parseInt(scheduleData.ass3_type, 10));
            setAss3TypeName(scheduleData.ass3_type_name);
            setAss3Time(scheduleData.ass3_time);
            if (typeof scheduleData.ass3_src === "undefined") {
                setAss3Src("")
            } else {
                setAss3Src(scheduleData.ass3_src);
            }
            ...
            setAss4Type(parseInt(scheduleData.ass4_type, 10));
            setAss4TypeName(scheduleData.ass4_type_name);
            setAss4Time(scheduleData.ass4_time);
            if (typeof scheduleData.ass4_src === "undefined") {
                setAss4Src("")
            } else {
                setAss4Src(scheduleData.ass4_src);
            }
