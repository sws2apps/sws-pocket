...
const Schedule = () => {
  ...
  }, [currentWeek, i18n, t, schedules, setAppMessage, setAppSeverity, setAppSnackOpen]);
    ...
    <Box>
      <Stack direction='row' spacing={2}>
        <Box sx={{ flexGrow: 1 }}>
          ...
          >
            <IconButton sx={styles.navBtnPrevNext} onClick={handlePreviousWeek} disabled={disablePrevious}>
              <SkipPreviousIcon sx={styles.navIcon} />
            </IconButton>
            <IconButton sx={styles.navBtnHome} onClick={handleActiveWeek}>
              <HomeIcon sx={styles.navIcon} />
            </IconButton>
            <IconButton sx={styles.navBtnPrevNext} onClick={handleNextWeek} disabled={disableNext}>
          ...
          {isLoading && (
            ...
            >
              <CircularProgress color='secondary' size={50} disableShrink={true} />
            </Box>
          )}
          {!isLoading && (
            <Box sx={{ marginTop: '5px' }}>
              ...
              >
                <Typography sx={{ fontSize: '18px', fontWeight: 'bold' }}>{currentWeekDate}</Typography>
                <Typography sx={{ fontSize: '14px', fontWeight: 'bold' }}>{t('midweekMeeting')}</Typography>
              </Box>

              <Box sx={{ ...styles.boxMeetingPart, backgroundColor: '#656164' }}>
              ...
              <Box sx={{ ...styles.boxMeetingPart, backgroundColor: '#a56803' }}>
                <Typography variant='h6' sx={{ lineHeight: 1.3 }}>
                  {t('fieldMinistryPart')}
                </Typography>
              </Box>
